...
// 7 Map
let NewMap = function(array, accumulator=[]){
  this.map = function(fFunction ){
    for (let i of array){
      accumulator.push(fFunction(i))
    }
    return accumulator
  }
}
let a = [1,2,3,4,5]
function func(a){return a**2}
let example = new NewMap(a)
console.log(example.map( func));
